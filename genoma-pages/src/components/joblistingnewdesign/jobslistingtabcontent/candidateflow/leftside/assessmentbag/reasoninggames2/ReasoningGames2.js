...
import SingleReasoningGame2 from "./singlereasoninggame2/SingleReasoningGame2";
...
class ReasoningGames2 extends Component {
  render() {
      ...
      <div>
        <Grid container className={classes.gameHead}>
          ...
          <Grid item xs={1} sm={6} className={classes.numbGame}>
            <Typography variant="h6" className={classes.heading}>
              (03) <span className={classes.showSpan}>GAMES</span>
            </Typography>
          </Grid>
        </Grid>
        <Grid container>
...
ReasoningGames2.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(ReasoningGames2);
